...
class ClickTextCommand : CommandBase() {
    ...
    override fun execute(server: MinecraftServer, sender: ICommandSender, args: Array<String>) = handlers[UUID.fromString(args[0])]?.accept(sender as EntityPlayerMP)?: Unit
}
